          ...
          <>
            ...
            >
              ...
              {!latestPendingLeave ? (
                ...
                >
                  <div
                    style={{ fontWeight: "600", fontSize: 20, color: "#2980b9" }}
                  >
                  ...
                  <div>
                    <strong>From:</strong> {latestPendingLeave.start_date}
                  </div>
                  <div>
                    <strong>To:</strong> {latestPendingLeave.end_date}
                  </div>
                  <div>
                ...
                <tbody>
                  ...
                  {leaveRequests.map((leave) => (
                    ...
                    >
                      ...
                      <td style={{ padding: 12 }}>{leave.start_date}</td>
                      <td style={{ padding: 12 }}>{leave.end_date}</td>
